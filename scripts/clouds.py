...
class Cloud:
    ...
    def render(self, surf, offset=(0, 0)):
        render_pos = (self.pos[0] - offset[0] * self.depth, self.pos[1] - offset[1] * self.depth) # depth included to slow/speed up movement based on distance (parallax effect)
...
class Clouds:
    def __init__(self, cloud_images, count=16):
        ...
        self.clouds.sort(key=lambda x: x.depth) # sort and draw based on depth
